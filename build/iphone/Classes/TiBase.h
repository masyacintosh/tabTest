...
// in simulator we redefine to format for tabTest Developer console
...
{\
	NSString * exceptionName = [@"org.tabtest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tabtest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItabTestNativeItemNone = -1, 
	UItabTestNativeItemSpinner = -2,
	UItabTestNativeItemProgressBar = -3,
	
	UItabTestNativeItemSlider = -4,
	UItabTestNativeItemSwitch = -5,
	UItabTestNativeItemMultiButton = -6,
	UItabTestNativeItemSegmented = -7,
	
	UItabTestNativeItemTextView = -8,
	UItabTestNativeItemTextField = -9,
	UItabTestNativeItemSearchBar = -10,
	
	UItabTestNativeItemPicker = -11,
	UItabTestNativeItemDatePicker = -12,
	
	UItabTestNativeItemInfoLight = -13,
	UItabTestNativeItemInfoDark = -14,
	
	UItabTestNativeItemDisclosure = -15,
	
	UItabTestNativeItemContactAdd = -16
};
