 ...
 * Copyright (c) 2009-2011 by tabTest, Inc. All Rights Reserved.
...
//@interface tabTestObject : NSObject
//@end

@interface tabTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tabTestObject class]])
		{
			for (NSString *key in [[(tabTestObject*)o modules] allKeys])
			{
